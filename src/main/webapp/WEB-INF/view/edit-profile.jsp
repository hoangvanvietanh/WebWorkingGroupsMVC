				...
				<div class="dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right">
						<a class="dropdown-item" data-toggle="modal"
							data-target="#profile-edit-modal" href="">Account Settings</a> <a
							class="dropdown-item" href="account/change-password"
							method="post">Change Password</a> <a
							class="dropdown-item text-danger" href="account/deactivate">Deactivate</a>
						<div class="dropdown-divider"></div>
						<a class="dropdown-item text-danger" href="sign-in/logout">Log
							out</a>
					</div>
				</div>
			</div>
								...
								<div class="sidebar">
									<div class="widget">
										<div class="user-photo">
											<a href="profile/avatar/${emailProfile }"> <img
												src="assets/img/tmp/agent-2.jpg" alt="User Photo"> <span
												class="user-photo-action">Click here to reupload</span>
											</a>
										</div>
										<!-- /.user-photo -->
									</div>
								...
								<div class="col-sm-8 col-lg-9">
										...
										<div class="background-white p20 mb30">
											...
											<div class="row">
												<div class="form-group col-sm-6">
													<label>Name</label>
													<form:input type="text" readonly="true" path="name"
														class="form-control" />
												</div>
												<!-- /.form-group -->
												<div class="form-group col-sm-6">
												...
												<div class="form-group col-sm-6">
													<label>Phone</label>
													<form:input path="phone" readonly="true" type="text"
														class="form-control" />
												</div>
												<!-- /.form-group -->
												<div class="form-group col-sm-6">
													<label>Address</label>
													<form:input path="address" readonly="true" type="text"
														class="form-control" />
												</div>
												<!-- /.form-group -->
												<div class="form-group col-sm-6">
													<label>Skill</label>
													<form:input path="skill" type="text" readonly="true"
														class="form-control" />
												</div>
												<div class="form-group col-sm-6">
													<label>Experience</label>
													<form:input path="experience" type="text" readonly="true"
														class="form-control" />
												</div>
											</div>
											<!-- /.row -->
									...
									<div class="background-white p20 mb30">
										...
										<form:textarea class="form-control" path="about"
											readonly="true" rows="7"></form:textarea>
									</div>

								</div>
							</form:form>

							<form:form modelAttribute="profile" action="profile/edit-profile"
								class="modal fade" id="profile-edit-modal" tabindex="-1"
									...
									<div class="modal-content">
										...
										<ul class="nav nav-tabs nav-fill">
											<li class="nav-item"><a class="nav-link active"
												...
												aria-controls="profile-add-details" aria-selected="true">Your
													Profile</a></li>
										</ul>
											...
											<div class="tab-content">
												<div class="tab-pane fade show active"
													...
													<div class="form-group row">
														...
														<form:textarea class="form-control col" name="content" id="editor"
															placeholder="Your skills" path="skill"></form:textarea>
													</div>
													<div class="form-group row">
														<label class="col-3">Expriences</label>
														<form:textarea class="form-control col" name="content" id="editor"
															placeholder="Experiences that you have gained"
															path="experience"></form:textarea>
													</div>
