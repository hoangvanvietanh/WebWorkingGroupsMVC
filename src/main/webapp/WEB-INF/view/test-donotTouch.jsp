...
<body>
	...
	<div class="layout layout-nav-top">
			...
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-lg-11 col-xl-10">
										...
										<c:forEach var="note" items="${notes }">
											<div class="card card-note">
												<div class="card-header">
													<div class="media align-items-center">
														...
														<div class="media-body">
															<h6 class="mb-0" data-filter-by="text" id="note-title-${note.id }">${note.titleNotes }</h6>
														</div>
													</div>
													<div class="d-flex align-items-center">
														...
														<div class="ml-1 dropdown card-options">
															...
															<div class="dropdown-menu dropdown-menu-right">
																<a class="dropdown-item edit-note-open" id="edit-note-${note.id }" href="#">Edit</a> <a
												...
												<div class="card-body" data-filter-by="text">
													<p id="note-notes-${note.id	 }">${note.notes}</p>
												</div>
											</div>
										</c:forEach>
						...
						<div class="modal fade" id="note-edit-modal" role="dialog" >
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									<div class="modal-header">
									...
									<div class="modal-body">
										<div class="form-group row align-items-center">
											...
											<input class="form-control col" type="text"
												placeholder="Note title" id="edit-note-title" />
										</div>
										<div class="form-group row align-items-center">
											<label class="col-3">Note</label>
											<textarea class="form-control col" rows="6" id="edit-note-notes"></textarea>
										</div>
									...
									<!--end of modal body-->
									<div class="modal-footer">
										<button id="edit-submit" role="button" class="btn btn-primary" type="submit">
											Save</button>
									</div>
								</div>
							</div>
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										<div class="form-group row align-items-center">
											<label class="col-3">Title</label>
											<form:input class="form-control col" type="text"
												placeholder="Note title" id="edit-note-title" path="titleNotes" />
										</div>
										<div class="form-group row align-items-center">
											<label class="col-3">Note</label>
											<form:textarea class="form-control col" rows="6" id="edit-note-notes"
		...
		<!-- asdjbasjashdjsahdajsdhajsdhbajsbd 
		
		<div class="fixed-container" id="edit-note-container"
			style="position: fixed; top: 25%; left: 25%; background-color: #eee; width: 500px; height: 400px; display: none;">
			<input type="text" style="width: 100%" id="edit-note-title" placeholder="Title">
			<input type="text" style="width: 100%" id="edit-note-notes" placeholder="Notes">
	...
	<script src="<spring:url value='/resources/js/theme.js'/>"
		...
		<script>
			$(document).ready(function() {
				var note_edit_container = $('#note-edit-modal');
				var note_edit_title = $('#edit-note-title');
				var note_edit_notes = $('#edit-note-notes');
				var note_id;
				
				$('.edit-note-open').click(function(event) {
					event.preventDefault();
					console.log(this.id);
					note_edit_container.show("slow");
					note_id = this.id.match(/\d+/).toString();
					note_edit_title.val($('#note-title-' + note_id).text());
					note_edit_notes.val($('#note-notes-' + note_id).text());
				});
				
				$('#edit-submit').click(function() {
					$.ajax({
						type : 'GET',
						url : '/time-is-gold/task-todo/edit-note',
						data : {
							id : note_id,
							title : note_edit_title.val(),
							note : note_edit_notes.val()
						}
					});
				});
